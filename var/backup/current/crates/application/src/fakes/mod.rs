...
use crate::ports::{
    AdvanceTx, BootstrapTx, Clock, CommentTx, CommentWriter, Committable, ContentTx, DepositTx,
    DepositWriter, IdempotencyGuard, IntegritySweepIo, IntegrityTx, InvariantReadTx, LedgerWriter,
    LifecycleCommandWriter, MarketQueries, MarketReader, MarketWriter, NotificationQueries,
    NotificationTx, NotificationWriter, NotifyReader, OpsAuditTx, OpsConfigTx, OutboxWriter,
    PoolWriter, PositionWriter, RealizationWriter, ResolveTx, SeedEconomyIo, SeedTx, SettlementIo,
    SocialQueries, Store, TradeEconomyReader, TradeTx, TradeWriter, UnwindTx, UserLockGuard,
    UserReader, UserWriter, VideoTx, VoteReader, VoteTx, VoteWriter,
};
